...
All_MAMPs <- correlation_curves(disease_subset_RLUs) + ggtitle("All MAMPs")
#dev.off()
...
Single_MAMPs <- ggpubr::ggarrange(correlation_curves(subset(disease_subset_RLUs, variable == "Chitin")) + ggtitle("Chitin"),
